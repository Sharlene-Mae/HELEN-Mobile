...
import 'package:helen_app/buyers/order-form.dart';
import 'nav-bar-buyer.dart';

class HomePageBuyer extends StatefulWidget {
  const HomePageBuyer({Key? key}) : super(key: key);
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const NavbarBuyer(initialIndex: 1), // 1 is the index for Messages tab
                    ),
                  );
                },
                child: Text(
